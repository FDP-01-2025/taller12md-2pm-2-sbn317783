...
void modificarEstudiante() {
    ...
    int studentFinder; // we use this number to find the user we want to replace
    Estudiante e; // use use this method to change the old user with the new user
    string buscado;
    cout << "Cual estudiante quieres cambiar?";
    cin >> buscado;
